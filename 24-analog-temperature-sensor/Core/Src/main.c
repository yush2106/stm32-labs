...
int main(void)
{
  ...
  LCD_GoTo_Position(0, 0);    //move to row 1 position of LCD
  ...
  while (1)
  {
    ...
    Temperature = (Temperature-500) / 10.0;    //calculate temperature value
    LCD_GoTo_Position(1, 0);    //move to row 2 position of LCD
