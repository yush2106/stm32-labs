## Simple counter UART transmission

This project, use UART to display the counter number result on the PuTTY terminal.

Set PA2 and PA3 for UART connection.
...
Step 4: Display the counter number result.

![image](https://github.com/yush2106/stm32-labs/blob/main/34-uart-simple-counter/img/34-uart-simple-counter-01.jpg)