## Build Printf for Debugging

In this project, try to build a printf-like function, use Instrumentation Trace Macrocell (ITM) to display text in the debug window.
...
Step 5: Configure float printing

Project -> Properties

C/C++ Build -> Settings -> MCU/MPU GCC Linker -> Miscellaneous

Add flag: **-u_printf_float**

![image](https://github.com/yush2106/stm32-labs/blob/main/46-debug-printf/img/46-debug-printf-01.jpg)

Step 6: Set the break point

![image](https://github.com/yush2106/stm32-labs/blob/main/46-debug-printf/img/46-debug-printf-02.jpg)
...
Step 8: Show SWM ITM Data Console
...
When press F8 several times, check the Variables and display text in the window.

![image](https://github.com/yush2106/stm32-labs/blob/main/46-debug-printf/img/46-debug-printf-03.jpg)

![image](https://github.com/yush2106/stm32-labs/blob/main/46-debug-printf/img/46-debug-printf-04.jpg)